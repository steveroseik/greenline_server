...
export class Initial1707341492061 implements MigrationInterface {
    name = 'Initial1707341492061'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`courierSheet\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`sheetOrderStatusHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`sheetOrderId\` int NOT NULL, \`status\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`userId\` (\`userId\`), INDEX \`sheetOrderId\` (\`sheetOrderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`sheetOrder\` (\`id\` int NOT NULL AUTO_INCREMENT, \`sheetId\` int NOT NULL, \`orderId\` int NOT NULL, \`transactionId\` int NOT NULL, \`createdAt\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`orderId\` (\`orderId\`), INDEX \`sheetId\` (\`sheetId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`orderStatus\` (\`id\` int NOT NULL AUTO_INCREMENT, \`orderId\` int NOT NULL, \`status\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`orderId\` (\`orderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`financialRequestStatus\` (\`requestId\` int NOT NULL, \`status\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (\`requestId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`financialTransaction\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`fromAccountId\` int NOT NULL, \`toAccountId\` int NOT NULL, \`amount\` float(12) NOT NULL, \`receipt\` varchar(255) NOT NULL, \`latestStatus\` int NOT NULL, \`approvedById\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`approvedById\` (\`approvedById\`), INDEX \`toAccountId\` (\`toAccountId\`), INDEX \`fromAccountId\` (\`fromAccountId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`expense\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` varchar(255) NOT NULL, \`fromAccountId\` int NOT NULL, \`amount\` float(12) NOT NULL, \`receipt\` varchar(255) NOT NULL, \`comment\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`fromAccountId\` (\`fromAccountId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`financialAccount\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`merchantId\` int NOT NULL, \`balance\` float(12) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`merchantId\` (\`merchantId\`), INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`itemPrice\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemSku\` varchar(255) NOT NULL, \`currency\` varchar(255) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`discount\` decimal(10,2) NULL, \`startDiscount\` timestamp NULL, \`endDiscount\` timestamp NULL, INDEX \`itemSku\` (\`itemSku\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`orderItem\` (\`orderId\` int NOT NULL, \`itemSku\` varchar(255) NOT NULL, \`count\` int NOT NULL, \`frozenPrice\` decimal(10,2) NULL, \`frozenCurrency\` varchar(10) NULL, \`partial\` tinyint NOT NULL DEFAULT 0, \`partialCount\` int NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`itemSku\` (\`itemSku\`), PRIMARY KEY (\`orderId\`, \`itemSku\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`orderRelation\` (\`firstOrderId\` int NOT NULL, \`secondOrderId\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`secondOrderId\` (\`secondOrderId\`), PRIMARY KEY (\`firstOrderId\`, \`secondOrderId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`otherId\` int NOT NULL, \`type\` int NOT NULL, \`paymentType\` int NOT NULL, \`userId\` varchar(255) NOT NULL, \`merchantId\` int NOT NULL, \`userAddressId\` int NOT NULL, \`shippingPrice\` float(12) NOT NULL, \`includesVAT\` tinyint(1) NOT NULL, \`canOpen\` tinyint NOT NULL DEFAULT 0, \`fragile\` tinyint NOT NULL DEFAULT 0, \`deliveryPart\` tinyint NOT NULL DEFAULT 0, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`userAddressId\` (\`userAddressId\`), INDEX \`merchantId\` (\`merchantId\`), INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`userAddress\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` varchar(255) NOT NULL, \`countryId\` int NOT NULL, \`cityId\` int NOT NULL, \`details\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`requestStatusHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`requestId\` int NOT NULL, \`status\` int NOT NULL, \`userId\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`requestId\` (\`requestId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`request\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`priority\` int NOT NULL, \`fromId\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`fromId\` (\`fromId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(255) NOT NULL, \`type\` varchar(20) NOT NULL, \`hubId\` int NULL, \`merchantId\` int NULL, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`phone\` varchar(15) NOT NULL, \`birthdate\` datetime NOT NULL, \`refreshToken\` varchar(64) NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`deletedAt\` timestamp NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`inventoryHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemInBoxId\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`type\` int NOT NULL, \`amount\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`itemInBoxId\` (\`itemInBoxId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`itemInBox\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemSku\` varchar(255) NOT NULL, \`boxId\` int NOT NULL, \`count\` int NOT NULL, \`minCount\` int NOT NULL, \`inventoryId\` int NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`boxId\` (\`boxId\`), INDEX \`itemSku\` (\`itemSku\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`box\` (\`id\` int NOT NULL AUTO_INCREMENT, \`ballotId\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`ballotId\` (\`ballotId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`ballot\` (\`id\` int NOT NULL AUTO_INCREMENT, \`rackId\` int NOT NULL, \`level\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`rackId\` (\`rackId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`rack\` (\`id\` int NOT NULL AUTO_INCREMENT, \`inventoryId\` int NOT NULL, \`levels\` int NOT NULL DEFAULT '1', \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, \`lastModified\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, INDEX \`inventoryId\` (\`inventoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`inventorySupport\` (\`id\` int NOT NULL AUTO_INCREMENT, \`inventoryId\` int NOT NULL, \`governorateId\` int NOT NULL, \`zoneId\` int NOT NULL, INDEX \`inventoryId\` (\`inventoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`inventoryPrices\` (\`id\` int NOT NULL AUTO_INCREMENT, \`inventoryId\` int NOT NULL, \`currency\` varchar(255) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`discount\` decimal(10,2) NULL, \`startDiscount\` timestamp NULL, \`endDiscount\` timestamp NULL, INDEX \`inventoryId\` (\`inventoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`itemSku\` ON \`itemPrice\``);
