...
export class Initital1710589941904 implements MigrationInterface {
    name = 'Initital1710589941904'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`inventory-history\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemInBoxId\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`type\` enum ('import', 'newImport', 'orderReturn', 'export', 'orderExport') NOT NULL, \`amount\` int NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`lastModified\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), INDEX \`itemInBoxId\` (\`itemInBoxId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
