...
export class Initial1706102618190 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`courierSheet\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`sheetOrderStatusHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`sheetOrderId\` int NOT NULL, \`status\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, INDEX \`userId\` (\`userId\`), INDEX \`sheetOrderId\` (\`sheetOrderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`sheetOrder\` (\`id\` int NOT NULL AUTO_INCREMENT, \`sheetId\` int NOT NULL, \`orderId\` int NOT NULL, \`latestStatus\` int NOT NULL, \`createdAt\` datetime NOT NULL, INDEX \`orderId\` (\`orderId\`), INDEX \`sheetId\` (\`sheetId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`orderStatus\` (\`id\` int NOT NULL AUTO_INCREMENT, \`orderId\` int NOT NULL, \`status\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`orderId\` (\`orderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`financialTransaction\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`fromAccountId\` int NOT NULL, \`toAccountId\` int NOT NULL, \`amount\` float(12) NOT NULL, \`receipt\` varchar(255) NOT NULL, \`latestStatus\` int NOT NULL, \`approvedById\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, INDEX \`approvedById\` (\`approvedById\`), INDEX \`toAccountId\` (\`toAccountId\`), INDEX \`fromAccountId\` (\`fromAccountId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`expense\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` varchar(255) NOT NULL, \`fromAccountId\` int NOT NULL, \`amount\` float(12) NOT NULL, \`receipt\` varchar(255) NOT NULL, \`comment\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, INDEX \`fromAccountId\` (\`fromAccountId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`financialAccount\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`userId\` varchar(255) NOT NULL, \`merchantId\` int NOT NULL, \`balance\` float(12) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`merchantId\` (\`merchantId\`), INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`merchant\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`includesVAT\` tinyint(1) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`otherId\` int NOT NULL, \`type\` int NOT NULL, \`userId\` varchar(255) NOT NULL, \`merchantId\` int NOT NULL, \`userAddressId\` int NOT NULL, \`shippingPrice\` float(12) NOT NULL, \`includesVAT\` tinyint(1) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`userAddressId\` (\`userAddressId\`), INDEX \`merchantId\` (\`merchantId\`), INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`userAddress\` (\`id\` int NOT NULL AUTO_INCREMENT, \`userId\` varchar(255) NOT NULL, \`countryId\` int NOT NULL, \`cityId\` int NOT NULL, \`details\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`userId\` (\`userId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`requestStatusHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`requestId\` int NOT NULL, \`status\` int NOT NULL, \`userId\` int NOT NULL, \`createdAt\` timestamp NOT NULL, INDEX \`requestId\` (\`requestId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`request\` (\`id\` int NOT NULL AUTO_INCREMENT, \`type\` int NOT NULL, \`priority\` int NOT NULL, \`fromId\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`fromId\` (\`fromId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(255) NOT NULL, \`type\` varchar(20) NOT NULL, \`hubId\` int NULL, \`merchantId\` int NULL, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`phone\` varchar(15) NOT NULL, \`birthdate\` datetime NOT NULL, \`refreshToken\` varchar(64) NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, \`deletedAt\` timestamp NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`inventoryHistory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemInBoxId\` int NOT NULL, \`description\` varchar(255) NOT NULL, \`type\` int NOT NULL, \`amount\` int NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`itemInBoxId\` (\`itemInBoxId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`itemInBox\` (\`id\` int NOT NULL AUTO_INCREMENT, \`itemSku\` varchar(255) NOT NULL, \`boxId\` int NOT NULL, \`count\` int NOT NULL, \`minCount\` int NOT NULL, \`inventoryId\` int NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`boxId\` (\`boxId\`), INDEX \`itemSku\` (\`itemSku\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`box\` (\`id\` int NOT NULL AUTO_INCREMENT, \`ballotId\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`ballotId\` (\`ballotId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`ballot\` (\`id\` int NOT NULL AUTO_INCREMENT, \`rackId\` int NOT NULL, \`level\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`rackId\` (\`rackId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`rack\` (\`id\` int NOT NULL AUTO_INCREMENT, \`inventoryId\` int NOT NULL, \`levels\` int NOT NULL, \`name\` varchar(255) NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, INDEX \`inventoryId\` (\`inventoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`inventory\` (\`id\` int NOT NULL AUTO_INCREMENT, \`hubId\` int NULL, \`name\` varchar(255) NOT NULL, \`module\` int NOT NULL, \`zoneId\` int NOT NULL, \`location\` point NOT NULL, \`rentType\` int NOT NULL, \`createdAt\` timestamp NOT NULL, \`lastModified\` timestamp NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`inventoryPrices\` (\`id\` int NOT NULL AUTO_INCREMENT, \`inventoryId\` int NOT NULL, \`currency\` varchar(255) NOT NULL, \`pricePerUnit\` float(12) NOT NULL, \`discount\` float(12) NOT NULL, \`startDiscount\` timestamp NOT NULL, \`endDiscount\` timestamp NOT NULL, INDEX \`inventoryId\` (\`inventoryId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
